...
You now have the choice to use the properties view with UI help to configure Camel components or to use source editor and benefit from completion. All depends on your coding style!
