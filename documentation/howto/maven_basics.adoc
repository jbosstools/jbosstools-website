...
[NOTE]
Note that the provided instructions pertain to the "create a simple project" path. If this is not the desired path, ensure that the group ID, version, package, and archetype properties are set or overridden as required for a custom project.
