...
== Developing Apps for the Cloud (OpenShift v2.x)
...
== Developing Apps for the Cloud (OpenShift v3.x)

link:os3_firstapp.html[Create Your First OpenShift v3 Application]
