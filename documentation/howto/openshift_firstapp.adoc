= Create and Deploy your First OpenShift Online Application 
:page-layout: howto
:page-tab: docs
:page-status: green
:experimental:
...
* To manually reconnect the IDE to OpenShift, in the `OpenShift Explorer` view click the `Connection` icon image:images/openshift_icon-connection.png[Connection icon].