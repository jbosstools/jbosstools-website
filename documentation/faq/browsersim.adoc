...
If you install Oracle JDK via package manager(using command like `yum install java-1.7.0-oracle-1.7.0`) you also need to install JavaFX package. It can be installed using command like `yum install java-1.7.0-oracle-javafx`.