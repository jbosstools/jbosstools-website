...
:page-feature_tagline: Not pressing F5 is refreshing

== Overview
=== Not pressing F5 is refreshing
image::images/liveReload_server_configuration_with_security.png[]
...
image::images/livereload_open_with_webbrowser_via_livereload_server.png[]
...
image::images/l iveReload_open_in_web_browser_via_browser-messagedialog.png []
