...
Fix release versions of Fuse Tooling 7.2.2, jBPM/Drools 6.1.0  and Teiid Designer 8.3.4.  Also - there are updated ESB 1.5.310.Final project examples.  Look for specific bug fixes in the link:https://devstudio.jboss.com/updates/7.0/integration-stack/release-notes/Release_Notes_7.0.3.html[Release Notes].
