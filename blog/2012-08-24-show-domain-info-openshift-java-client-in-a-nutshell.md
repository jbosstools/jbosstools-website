...
System.out.println("\tFramework:\t"</font> + application.getCartridge().getName());
System.out.println("\tCreation:\t"</font> + application.getCreationTime());
System.out.println("\tUUID:\t\t"</font> + application.getUUID());
System.out.println("\tGit URL:\t"</font> + application.getGitUrl());
System.out.println("\tPublic URL:\t"</font> + application.getApplicationUrl() + "\n");
~~~
