...
But beyond this it also allow you to say "Remember this choice for this server", allowing you to i.e. click "Restart modules" once and then all consequent hot code replace
failed will just automatically trigger a restart of just the modules.
...
I'll spare you for the details here but just outline that the rewiring has been completed and we now support
