...
Common namespace was link:/documentation/whatsnew/4.4.2.AM1.html#openshift[added] but templates were still loaded from the hardcoded `openshift` namespace.
