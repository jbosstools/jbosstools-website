...
a| * You can download and install Red Hat JBoss Developer Studio 7.1.1 from https://devstudio.jboss.com/earlyaccess/[here]
...
a| * Download and install https://www.eclipse.org/downloads/packages/eclipse-ide-java-ee-developers/keplersr2[Eclipse Java EE Kepler SR2]
* JBoss Tools 4.1.2 can be installed from 
...
* https://issues.jboss.org/browse/JBIDE/component/12312576 for the JBoss Tools version
