...
Please note that in Beta2 on Windows 64 bit you will need to
http://nodejs.org/download/[Download and Install node.js] to have it
working - in the next release we will have this handled out of the
box. Windows 32-bit, Linux and OS X users should be able to see it
enabled on any javascript project.
