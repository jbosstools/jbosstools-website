...
I am happy to announce some of the highlights of the upcoming release of the https://tools.jboss.org/features/apachecamel.html[Red Hat JBoss Fuse Tooling].
