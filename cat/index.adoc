...
* Download the latest JBoss Tools bits - as of today you should install: link:http://download.jboss.org/jbosstools/updates/staging/luna/jbosstools-4.2.0.CR1b-updatesite-core/[4.2.0.CR1 respin-b]
...
* 2014/09/17 -- JBoss Tools 4.2.0.CR1 released
