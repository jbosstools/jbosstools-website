...
== What Happens to the Bugs and Feature Requests that you log?

The JBoss Tools CAT team managers will review and respond to all new bugs and feature requests.

== How Can JBoss Tools CAT Members get Help with Questions?

By sending email to the JBoss Tools CAT mailing list. 
